  ...
  <script>   
	...
	<H2 class='text-center'>Haladási napló</H2>
		<div class='row'>
			...
			<div class='col-md-1'>
				<a href='<?=base_url()?>Osztalyfonok/haladasinaplo/<?=$targy2?>'>
		...
		<?php foreach ($naplo as $n):?>
			...
			<div class='row'>
				...
				<div class='col-md-6'>
				<?php echo form_open('Osztalyfonok/haladasinaplokesz');?>
		...
		<div id='ujnaplo'>
				...
				?>
				<?php echo form_open('Osztalyfonok/haladasi_naplo_uj','',$hidden);?>
				<div class="row">

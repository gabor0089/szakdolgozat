...
<HTML>
	...
	<BODY>
	<?php echo form_open('Osztalyfonok/osztalyozas_csoportos');?>
	...
	<div class='container'>
		...
		<tr class='row'>
			<?PHP echo form_open('Osztalyfonok/osztalyozas_diakok')?>
			<td class='col-md-3'>
		...
		<?php if(isset($diakok)):?>
			<td class='col-md-3'>
					<?php foreach ($diakok as $d => $value):?>
						<?php echo form_open('Osztalyfonok/osztalyozas_tantargy');?>
		...
		<?php if(isset($targyak)):?>
			...
			<td class='col-md-3'>
					...
					<?php echo form_open('Osztalyfonok/Jegyek_egyeni');?>
						<input type='hidden' name='tantargyid' value='<?=$value['tantargyid']?>'>

...
<HTML>
	...
	<BODY>
		<?php echo form_open('Osztalyfonok/osztalyozas_egyeni');?>
	        ...
	        <tr class='row'>
				<td class='col-md-1'>
					<?php foreach ($osztalyok as $o => $value):?>
						<?php echo form_open('Osztalyfonok/osztalyozas_csoportos_osztaly');?>
		...
		<?php if(isset($tantargyak)):?>
	        ...
	        <tr class='row'>
				...
				<?php foreach ($tantargyak as $t => $value):?>
					<?php echo form_open('Osztalyfonok/jegyek_csoportos');?>	

...
<div class='h2 text-center'>Oktatók</div>
          ...
          <tbody>
            <?php for($i=1;$i<count($kollegak);$i++):?>
              <tr class='sor'>
                ...
                <td><a target="_blank" href='<?=base_url()?>Users/Ujuzenet/<?=$kollegak[$i]['userid']?>'><img src="<?php echo base_url();?>assets/img/boritek.png"></a></td>
              </tr>
            <?php endfor;?>
          </tbody>
        </table>

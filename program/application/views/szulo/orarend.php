...
<HTML>
	...
	<BODY>
		<div class='row'>
			<div class='col-md-12 text-center'><H1>Órarend<a href="<?php echo base_url();?>Szulo/OrarendExport"><img src='<?php echo base_url();?>assets/img/orarend_letoltes.png' width='50' height='50'></a></H1></div>
		</div>
				<?php

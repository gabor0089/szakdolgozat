...
<font size='2'>
		    <table border='1' cellpadding='4'>
		        ...
		        <tr>
		        	<td>1<BR></td>
					<td><?=$csengrend[1]['kezdes']?> - <?=$csengrend[1]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>2<BR></td>
					<td><?=$csengrend[2]['kezdes']?> - <?=$csengrend[2]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>3<BR></td>
					<td><?=$csengrend[3]['kezdes']?> - <?=$csengrend[3]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>4<BR></td>
					<td><?=$csengrend[4]['kezdes']?> - <?=$csengrend[4]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>5<BR></td>
					<td><?=$csengrend[5]['kezdes']?> - <?=$csengrend[5]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>6<BR></td>
					<td><?=$csengrend[6]['kezdes']?> - <?=$csengrend[6]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>7<BR></td>
					<td><?=$csengrend[7]['kezdes']?> - <?=$csengrend[7]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>8<BR></td>
					<td><?=$csengrend[8]['kezdes']?> - <?=$csengrend[8]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>9<BR></td>
					<td><?=$csengrend[9]['kezdes']?> - <?=$csengrend[9]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>
		        ...
		        <tr>
		        	<td>10<BR></td>
					<td><?=$csengrend[10]['kezdes']?> - <?=$csengrend[10]['vege']?></td>
		        	<?php for($i=1;$i<6;$i++):?>

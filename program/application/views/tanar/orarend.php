		    ...
		    <table class="table table-striped table-sm visible-xs visible-sm">
		        ...
		        <tr class='row'>
		        	<?php if(isset($e[2])):?><td class='col-xs-12 ora thick-border'>4. <?=$e[2]?></td><?php else:?>
		        		<td class='col-xs-12 thick-border'>4. &nbsp<br>&nbsp<br>&nbsp</td><?php endif;?>
		        </tr>
		        <tr class='row'>
		        	<?php if(isset($f[2])):?><td class='col-xs-12 ora thick-border'>5. <?=$f[2]?></td><?php else:?>
		        		<td class='col-xs-12 thick-border'>5. &nbsp<br>&nbsp<br>&nbsp</td><?php endif;?>
		        </tr>
		        <tr class='row'>
		        ...
		        <tr class='row'>
		        	<?php if(isset($h[2])):?><td class='col-xs-12 ora thick-border'>7. <?=$h[2]?></td><?php else:?>
		        		<td class='col-xs-12 thick-border'>7. &nbsp<br>&nbsp<br>&nbsp</td><?php endif;?>
		        </tr>
		        <tr class='row'>
		        	<?php if(isset($j[2])):?><td class='col-xs-12 ora thick-border'>8. <?=$j[2]?></td><?php else:?>
		        		<td class='col-xs-12 thick-border'>8. &nbsp<br>&nbsp<br>&nbsp</td><?php endif;?>
		        </tr>
		        <tr class='row'>
